...
import (
	...
	"github.com/vitineth/rest"
	"github.com/vitineth/rest/examples/stdlib/handlers/topic/post"
	"github.com/vitineth/rest/examples/stdlib/handlers/topics/get"
	"github.com/vitineth/rest/swaggerui"
)
...
func main() {
	...
	api.StripPkgPaths = []string{"github.com/vitineth/rest/example", "github.com/a-h/respond"}
